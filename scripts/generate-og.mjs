...
const svg = `<svg xmlns="http://www.w3.org/2000/svg" width="${W}" height="${H}" viewBox="0 0 ${W} ${H}">
  ...
  <!-- marca de registro -->
  <g stroke="#c41e2a" stroke-width="6" fill="none">
  ...
  <text x="222" y="268" font-family="Arial, sans-serif" font-size="30" letter-spacing="10" fill="#5cc3e8">INDUSTRIA GR&#193;FICA · SPACK</text>
  <text x="222" y="392" font-family="Arial, sans-serif" font-weight="bold" font-size="52" fill="#f6f4ee">Empaque que imprime valor</text>
  <text x="222" y="452" font-family="Arial, sans-serif" font-size="28" fill="#6b83a1">Desde 1979 · Santo Domingo, Rep&#250;blica Dominicana</text>
  ...
  <g>
    ...
    <rect x="750" y="${H - 28}" width="150" height="28" fill="#c41e2a"/>
    <rect x="900" y="${H - 28}" width="150" height="28" fill="#152840"/>
